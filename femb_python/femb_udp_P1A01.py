...
class FEMB_UDP(object):
    ...
    def read_reg(self, reg ):
        ...
        with FEMB_LOCK() as lock:
            ...
            try:
                ...
                print("FEMB_UDP--> Error read_reg{}: No read packet received from board, quitting".format(reg))
                sock_readresp.close()
                return None       
            ...
            #print ("FEMB_UDP--> Read Successful: reg={},value={}".format(reg,dataHexVal))
            time.sleep(self.REG_SLEEP)
            return dataHexVal
    ...
    def get_data_packets(self, num):
        ...
        with FEMB_LOCK() as lock:
            ...
            sock_data.bind((self.PC_IP,self.UDP_PORT_HSDATA))
